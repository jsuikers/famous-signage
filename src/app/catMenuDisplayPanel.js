...
function CatMenuDisplayPanel(pnode,pcontext){

  this.context = pcontext;
  this.parentNode = pnode;
  this.catPanelArray = ["Customer Relationship","Manufacturing","Software","Hotel Mgmt.","Civil Engg.","Hardware/Embedded"];
...
CatMenuDisplayPanel.prototype.show = function() {

  this.parentNode.setPosition(0,0,150);//.setAlign(0.2,0.25,1);
}

CatMenuDisplayPanel.prototype.hide = function() {
...
CatMenuDisplayPanel.prototype.drawPanel = function(){
  ...
  for(var i = 0; i < this.catPanelArray.length;i++){
    ...
    var cat = new CatDisplayPanel(this.parentNode.addChild(),this.catPanelArray[i],this.context);
